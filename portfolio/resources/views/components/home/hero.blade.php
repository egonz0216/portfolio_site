            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    <h1 class="text-dark dark:text-gray-200 font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6">
                        My Name is Ernesto. <br />
                        I am a <span class="rounded-md text-amber-600">Full Stack Web Developer</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a developer with 1 year of professional experience. <br />
                        I am passionate about creating web applications that are user-friendly, accessible and scalable. </br>
                    </p>
            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="lg:text-right lg:ml-auto">
                    <div class="relative inline-block z-10 pt-11 lg:pt-0">
                        <img src="{{ url('/img/me_hero.jpeg') }}" alt="hero" class="max-w-full lg:ml-auto rounded-lg" />
